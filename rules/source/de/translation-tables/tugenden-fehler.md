# Ars Magica Definitive Edition – Tugenden und Fehler / Virtues and Flaws

**Teil der deutschen Übersetzungstabellen** | Quellen: ArM_DE_Uebersetzungstabelle.md (Sek. 13–14) · ArM_DE_Zusatztermini.md
...
> **Hinweis zum Typ-Label „Tainted":**
> EN „Tainted" als Typ-Label → DE **„Befleckt"**; ~~FEHLER korrigiert~~ (18 Typ-Label-Vorkommen „Verdorben"/„Korrumpiert" → „Befleckt").
> **Achtung:** Der Flaw-Name „Depraved" → DE „Verdorben" (Abschnittstitel, beschreibender Text) bleibt unverändert.
...
|---|---|---|
| Diedne Magic | Diedne-Magie | |
| Elemental Magic | Elementarmagie | |
| Faerie-Raised Magic | Feengeprägte Magie | |
| Flawless Magic | Makellose Magie | |
| Flexible Formulaic Magic | Flexible Formulaische Magie | |
| Gentle Gift | Sanfte Gabe | |
| Leper Magus | Lepra-Magus | |
| Life-Linked Spontaneous Magic | Lebensgebundene Spontane Magie | |
| Major Magical Focus | Großer Magischer Fokus | |
| Mercurian Magic | Merkurische Magie | |
| Mythic Blood | Mythisches Blut | |
| Potent Magic | Potente Magie | |

### Hermetische Tugenden, Klein / Hermetic, Minor

| Englisch (EN) | Deutsch (DE) | Anmerkung |
|---|---|---|
| Adaptive Casting | Adaptives Zaubern | |
| Adept Laboratory Student | Begabter Laborlehrling | |
| Affinity with Art | Affinität zu (Kunst) | |
| Boosted Magic | Verstärkte Magie | |
| Cautious Sorcerer | Vorsichtiger Zauberer | |
| Cyclic Magic (positive) | Zyklische Magie (positiv) | |
| Deft Form | Gewandte Form | |
| Enduring Magic | Anhaltende Magie | |
...
| Hermetic Prestige | Hermetisches Ansehen | |
| Inventive Genius | Erfinderisches Genie | |
| Judicious Use of Vis | Bedachter Vis-Einsatz | |
| Life Boost | Lebensstärkung | |
...
| Quiet Magic | Stille Magie | |
| Secondary Insight | Nebenerkenntnis | |
| Side Effect | Nebeneffekt | |
| Skilled Parens | Erfahrener Parens | |
| Special Circumstances | Besondere Umstände | |
| Study Bonus | Studierbonus | |
| Subtle Magic | Subtile Magie | |
| Tethered Magic | Gefesselte Magie | |
| Weak Magic Resistance | Schwache Magieresistenz | |
...
| Englisch (EN) | Deutsch (DE) | Anmerkung |
|---|---|---|
| Animal Ken | Tierverständnis | |
| Dowsing | Wünschelrutengehen | |
| Enchanting (Ability) | Bezaubernde (Fertigkeit) | |
| Extractor of (Form) Vis | Vis-Gewinner der (Form) | |
| Fabric Ripper | Stoffzerreißer | |
| Faerie Blood | Feenblut | |
| Faerie Doctor | Feendoktor | |
| Faerie Magic | Feenmagie | |
| Familiarity with the Fae | Vertrautheit mit den Feen | |
...
| Convoluted Mind | Verschlungener Geist | Gespür für dämonisches Denken |
| Cyclic Magic (negative) | Zyklische Magie (negativ) | |
| Death Prophecy | Todesprophezeiung | |
| Educated | Gebildet | |
| Enduring Constitution | Ausdauernde Konstitution | |
| Enticer of Multitudes | Verführer der Massen | Version von Inspirierend zur Verleitung zu bösen Taten |
| Famous | Berühmt | |
| Forgettable Face | Unscheinbares Gesicht | Charakter wird kaum wiedererkannt |
| Free Expression | Freie Ausdrucksfähigkeit | |
| Good Teacher | Guter Lehrer | |
...
| Luck | Glück | |
| Privileged Upbringing | Privilegierte Erziehung | |
| Protection | Schutz | |
...
| Custos | Custos (Lat.) | |
| Educated | Gebildet | |
| Failed Apprentice | Gescheiterter Lehrling | |
| Gentleman / Gentlewoman | Edelmann / Edelfrau | |
| Knight | Ritter | |
...
### Hermetische Fehler, Groß / Hermetic, Major
...
| Rigid Magic | Starre Magie | |
| Unstructured Caster | Unstrukturierter Zauberer | |
...
| Englisch (EN) | Deutsch (DE) | Anmerkung |
|---|---|---|
| Ability Block | Fähigkeitsblock | |
| Bound Casting Tools | Gebundene Zauberwerkzeuge | |
| Bound Magic | Gebundene Magie | |
| Careless Sorcerer | Nachlässiger Zauberer | |
| Ceremonial Spontaneous Magic | Zeremonielle Spontane Magie | |
| Chaotic Magic | Chaotische Magie | |
| Clumsy Magic | Plumpe Magie | |
| Consumed Casting Tools | Verbrauchende Zauberwerkzeuge | |
| Corrupted Arts | Verderbte Künste | |
| Corrupted Spells | Verderbte Zauber | |
| Cyclic Magic (negative) | Zyklische Magie (negativ) | |
...
| Limited Magic Resistance | Begrenzte Magieresistenz | |
| Magic Addiction | Magiesucht | |
| Necessary Condition | Notwendige Bedingung | |
| No Familiar | Kein Vertrauter | |
| No Sigil | Kein Sigil | |
| Poor Formulaic Magic | Schwache Formulaische Magie | |
...
| Weak Spontaneous Magic | Schwache Spontane Magie | |
| Weird Magic | Sonderbare Magie | |

### Übernatürliche Fehler, Groß / Supernatural, Major
...
| Englisch (EN) | Deutsch (DE) | Anmerkung |
|---|---|---|
| Beloved Rival | Geliebter Rivale | |
| Blackmail | Erpressung | |
| Close Family Ties | Enge Familienbande | |
| Dependent | Schützling | |
| Enemies | Feinde | |
| Favors | Gefälligkeiten | |
| Infamous Parens | Berüchtigter Parens | |
| Lingering Injury | Anhaltende Verletzung | |
| Lost Love | Verlorene Liebe | |
| Mentor | Mentor | |
| Mistaken Identity | Verwechslung | |
| Oath of Fealty | Treueeid | |
| Tormenting Master | Quälender Meister | |
...
| Blind | Blind | |
| Clumsy | Ungeschickt | |
| Covenant Upbringing | Konventsprägung | |
| Deaf | Taub | |
| Deformed | Missgestaltet | |
| Fragile Constitution | Gebrechliche Konstitution | |
| Lame | Lahm | |

# Ars Magica Definitive Edition – Orden, Häuser und Tribunale

**Teil der deutschen Übersetzungstabellen** | Quellen: ArM_DE_Uebersetzungstabelle.md (Sek. 16–17, 20–21) · ArM_DE_Zusatztermini.md

**Legende:**
- (Lat.) = Lateinischer Begriff, wird unübersetzt beibehalten
- m. = Maskulinum · f. = Femininum · n. = Neutrum · Sg. = Singular · Pl. = Plural
- (= m.) = Femininum identisch mit Maskulinum

---

## Häuser des Ordens / Houses of Hermes

| Englisch (EN) | Deutsch (DE) | Domus Magna |
|---|---|---|
| House Bjornaer | Haus Bjornaer | Crintera (Rhein) |
| House Bonisagus | Haus Bonisagus | Durenmar (Rhein) |
| House Criamon | Haus Criamon | Höhle der Zuckenden Schatten (Alpen) |
| House Ex Miscellanea | Haus Ex Miscellanea | Cad Gadu (Stonehenge) |
| House Flambeau | Haus Flambeau | Val-Negra (Languedoc) |
| House Guernicus | Haus Guernicus | Magvillus (Römisch) |
| House Jerbiton | Haus Jerbiton | Valnastium (Alpen) |
| House Mercere | Haus Mercere | Harco (Römisch) |
| House Merinita | Haus Merinita | Irencillia (Rhein) |
| House Tremere | Haus Tremere | Coeris (Transylvanien) |
| House Tytalus | Haus Tytalus | Fudarus (Normandie) |
| House Verditius | Haus Verditius | Verdi (Römisch) |

---

## Tribunale / Tribunals

| Englisch (EN) | Deutsch (DE) | Region |
|---|---|---|
| Greater Alps Tribunal | Tribunal der Hohen Alpen | Alpenraum |
...
| Rhine Tribunal | Rheintribunal | Deutschland |
| Roman Tribunal | Römisches Tribunal | Italien |
...
## Lateinische Personenbezeichnungen / Latin Terms for People

*(= m.) = Femininum identisch mit Maskulinum*

| Maskulinum Sg. | Femininum Sg. | Maskulinum Pl. | Femininum Pl. | Englisch | Deutsch |
|---|---|---|---|---|---|
| Archimagus | Archimaga | Archimagi | Archimagae | Archmage | Erzmagus / Erzmaga |
| Consors | (= m.) | Consortes | (= m.) | Consors | Consors |
| Custos | (= m.) | Custodes | (= m.) | Custos | Custos / Grog (offiziell) |
| Filius | Filia | Filii | Filiae | Son / Daughter of Parens | Filius / Filia |
| Maior Domus | (= m.) | Maiores Domus | (= m.) | Autocrat | Maior Domus |
| Magus | Maga | Magi | Magae | Magus | Magus / Maga |
| Orbus | Orba | Orbi | Orbae | Orphan Magus | Orbus / Orba |
| Parens | (= m.) | Parentes | (= m.) | Parent (magus) | Parens |
| Pater | Mater | Patres | Matres | Father / Mother | Pater / Mater |
| Praeco | (= m.) | Praecones | (= m.) | Presiding Magus | Praeco |
| Primus | Prima | Primi | Primae | House Head | Primus / Prima |
| Quaesitor | Quaesitrix | Quaesitores | Quaesitrices | Quaesitor | Quaesitor |
| Sodalis | (= m.) | Sodales | (= m.) | Fellow | Sodalis |
| Socius | Socia | Socii | Sociae | Associate | Socius / Socia |

---

## Sonstige lateinische und griechische Fachbegriffe
...
| – | Aegis of the Hearth | – | Aegides of the Hearth | Aegis of the Hearth | Aegis des Herdes | Schutzzauber des Konvents |
| Tractatus | – | Tractatus | – | Tractatus | Tractatus | m., 4. Dekl.; Sg. = Pl. |
| – | Summa | – | Summae | Summa | Summa / Summae | f., 1. Dekl. |

---

## Weitere Begriffe / Additional Terms

*Ergänzungen aus ArM_DE_Zusatztermini.md, die nicht in der Haupttabelle stehen.*

...
pub use derived::{
    ...
    SurfacedModifier, WoundBand, WoundRange, casting_totals, combat_totals, derived_totals,
    encumbrance, fatigue_levels, lab_totals, longevity_bonus, magic_resistance,
